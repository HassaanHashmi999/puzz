...
export default function RevealPage() {
  ...
  return (
    <main className="relative min-h-screen text-white py-12 px-4 overflow-hidden"
      style={{
        background: "radial-gradient(circle at 30% 30%, #8b0000 0%, #4a0404 70%, #1a0000 100%)",
      }}
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          <div className="relative aspect-[16/9] overflow-hidden rounded-2xl shadow-2xl border-4 border-pink-300/50"
            style={{
        ...
        <motion.div
          ...
          style={{
            boxShadow: "0 0 60px rgba(139, 0, 0, 0.3), inset 0 0 30px rgba(139, 0, 0, 0.2)",
          }}
        >
...
Beghum you have been my support through every smile of yours, You've repected me 90%, Loyal 100% haina?😂(Mazak mazak), I'm your safe place, iss para main Ameen nahi tha (feedback😂), Ameen Love completing your note one year later, Ameen 1000 times♥️.
...
Ya Khuda, Mujhe maloom hai tu mujhe sun raha hai, kaheen na kaheen iss dil ki awaaz sun raha hai tu, ya Khuda  main na hi koi alim hun, na hi koi naik shaks jo teray se jo mangoon kabool ho jai, Ya Allah na hi main sajday main hun na hi teri bargah yani kabbah main, agar main koi nabi hota toh apni ummat ke liye dua mangta, agar main naik hota toh tammam musalmano ke liye kuch mangta par main yahan tujh se aik shaks mangne ke liye aya hun, ya allah tu har cheez pe kadir hai, tu kun keh de toh kya mumkin nahi, ya Allah uss ko mera likh de Hamna Salik ko mera likh de, ya khuda main janta hun woh meri hai par uss ko har din mera likh de, uss ka pyaar meray liye likh de, uss ki hasi our har aik dukh mera likh de, mujhe maloom hai tu diloon ko badlta hai, uss ka dil har subh meray liye morr de, ya Allah uss ke dil ki hifazat karna, kabhi uss pe taqlief na anay dena, Ya rabbi jo har sheh pe kadir hai mera dil janch ke uss ke hissay main likh de.

Hamna Salik hum end pe poonch gai hain, par kuch baatain hai jo kehni baqi hain, I adore you Hamna Salik nahi toh our kis ko karain ge, I miss your haq jatana. Pata hai balke yaad hai "Anyone can fall in love with the flowers but its beautiful to fall in love with something ordinary as the leaves" pata hai sometimes I don't feel speacial for you shyd tumne bolna chor diya mujhe hi bolna parta tha just to hear it back yan tumhare effort bhi shyd kum ho gai, par I'll always remember the love she gave the love she has, aik hi bartan main le aoun that are the leaves I love, she might not make me feel loved but she always makes me feel like I'm her man.`}
          </div>
